...
import (
	...
	"github.com/jmcbean/celeritas/cache"
	"github.com/jmcbean/celeritas/mailer"
	"github.com/jmcbean/celeritas/render"
	"github.com/jmcbean/celeritas/session"
...
func (c *Celeritas) New(rootPath string) error {
	...
	sess := session.Session{
		...
		CookieLPersist: c.config.cookie.persist,
...
func (c *Celeritas) BuildDSN() string {
	...
	case "postgres", "postgresql":
		dsn = fmt.Sprintf("host=%s port=%s user=%s dbname=%s sslmode=%s timezone=UTC connect_timeout=5",
			...
			os.Getenv("DATABASE_NAME"), os.Getenv("DATABASE_SSL_MODE"))
